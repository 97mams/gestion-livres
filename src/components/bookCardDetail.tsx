...
export function BookCardDetail({
  ...
  return (
    <div className="relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-3xl mx-auto border border-border bg-card">
      <div className="w-full md:w-1/3 grid place-items-start">
        <img
          src={`/uploads/${book?.mockupImages}`}
          alt={book?.mockupImages}
      ...
      <div className="w-full md:w-2/3 flex flex-col space-y-2 p-3">
        ...
        <h3 className="font-black text-forground md:text-3xl text-xl">
          {book?.title}
        </h3>
